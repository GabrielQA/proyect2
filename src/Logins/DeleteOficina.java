 ...
 * @author Gabriel
 */
public class DeleteOficina extends javax.swing.JFrame {
private Connection connection = null;
    ...
    /**
     * Creates new form DeleteOficina
     */
    public DeleteOficina() {
        initComponents();
    }
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        try {
            ...
            int z = s.executeUpdate("DELETE FROM oficina WHERE id  = '" + d + "'");
            if (z == 1) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DeleteOficina.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new DeleteOficina().setVisible(true);
            }
        });
    }
