 ...
 * @author Gabriel
 */
public class DeleteModelo extends javax.swing.JFrame {
private Connection connection = null;
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        try {
            ...
            int z = s.executeUpdate("DELETE FROM modelo WHERE id  = '" + d + "'");
            if (z == 1) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DeleteModelo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new DeleteModelo().setVisible(true);
            }
        });
    }
